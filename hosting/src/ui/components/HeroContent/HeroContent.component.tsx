    ...
    <S.HeroContent>
      ...
      <S.Row style={{ flex: 4 }}>
        ...
        <S.Row style={{ flexDirection: 'row' }}>
          <ButtonPill style={{ padding: 10, width: 120, margin: 10 }}>
            <Text size="M" style={{ color: '#FFF' }} text="REGISTER" bold unique />
          </ButtonPill>
          <ButtonPill invert style={{ padding: 10, width: 120, margin: 10 }}>
            <Text size="M" text="SIGN IN" bold unique />
          </ButtonPill>
        </S.Row>
      </S.Row>
