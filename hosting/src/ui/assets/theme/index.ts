...
export default {
  ...
  CLEAN_BACKGROUND: '#FFFFFF',
  DIRTY_BACKGROUND: '#FFFFFF',
  PRIMARY_COLOR: DARK_MODE ? C.DARK_PRIMARY : C.HABICHAT_PURPLE,
  ...
  HABICHAT_PURPLE: C.HABICHAT_PURPLE,
  HABICHAT_INDIGO: C.HABICHAT_INDIGO,
  HABICHAT_PINK: C.HABICHAT_PINK,
  HABICHAT_ORANGE: C.HABICHAT_ORANGE,
  HABICHAT_GREEN: C.HABICHAT_GREEN,
